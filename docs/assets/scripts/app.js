...
(function() {
    ...
    var appInitFunc = function() {
        ...
        if ("addEventListener" in document) {
            app.loadScript("https://code.jquery.com/jquery-3.0.0.min.js", "assets/scripts/jquery-3.0.0.min.js", init);

        // .. IE <= 8
        } else if ("attachEvent" in document) {
            app.loadScript("https://code.jquery.com/jquery-1.12.4.min.js", "assets/scripts/jquery-1.12.4.min.js", init);
        }
    };
